      ...
      <div className="bg-white px-5 py-16 sm:px-8 md:py-20">
        <div className="mx-auto grid min-w-0 max-w-[1320px] gap-12 md:grid-cols-2 lg:grid-cols-4 lg:gap-10">
          ...
          <div className="min-w-0">
            ...
            {isContactPage ? (
              <p
                className={`${footerSans} mt-5 max-w-sm text-[15px] font-medium leading-relaxed text-neutral-700 dark:text-slate-300 sm:text-base`}
              >
            ...
            <div className="mt-8 flex flex-wrap gap-3 sm:gap-4">
              {socialLinks.map(({ Icon, href, label }) => (
                <a
                  ...
                  aria-label={label}
                  className="flex size-11 min-h-11 min-w-11 shrink-0 items-center justify-center rounded-full border border-neutral-200 text-[#6B8F71] transition-colors hover:bg-neutral-100 active:scale-[0.98] dark:border-[#334155] dark:bg-[#1e293b] dark:text-emerald-300 dark:hover:bg-[#334155] sm:size-10 sm:min-h-10 sm:min-w-10"
                >
