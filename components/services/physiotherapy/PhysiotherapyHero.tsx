...
export default function PhysiotherapyHero() {
  return (
    <section
      className="relative isolate flex min-h-[max(500px,min(880px,78dvh))] flex-col justify-between overflow-hidden"
      aria-labelledby="physio-hero-heading"
    >
      <div className="absolute inset-0 z-0">
        <Image
          src="/physio1.jpg"
          alt="Physiotherapy session with agility ladder and exercise equipment"
          fill
          priority
          sizes="100vw"
      ...
      <div
        className="absolute inset-0 z-[1] bg-black/55 bg-gradient-to-b from-black/60 via-black/50 to-black/55"
        aria-hidden
      />
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 pb-28 pt-8 text-center md:pb-32">
        ...
        <h1
          ...
          className="mx-auto mt-10 max-w-4xl text-4xl font-bold leading-tight tracking-tight text-white sm:text-5xl md:text-6xl lg:text-[3.25rem] [text-shadow:_0_2px_24px_rgb(0_0_0_/_45%)]"
        >
          Physiotherapy
        </h1>
        ...
        <p className="mx-auto mt-8 max-w-3xl px-2 text-[17px] font-normal leading-relaxed text-white/95 md:text-lg [text-shadow:_0_1px_12px_rgb(0_0_0_/_40%)]">
          Rebuild strength, restore movement, and relieve pain through expert physiotherapy tailored to your
          body&apos;s needs.
        </p>

        <div className="mt-10 md:mt-14">
          <div
            className="mx-auto h-0.5 w-[6.75rem] rounded-full sm:h-[3px]"
